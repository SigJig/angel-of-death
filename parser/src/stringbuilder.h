...
// Count how many consecutive charcters c return true for f(c). If param back is
// false, it counts from front, otherwise from back.
int sbuilder_num_consec(struct sbuilder *builder, bool (*func)(char),
			bool back);
